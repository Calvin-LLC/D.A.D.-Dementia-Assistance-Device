cordova.define("@ionic-enterprise/secure-storage.SQLitePlugin", function(require, exports, module) { 
(function () {
  var DB_STATE_INIT,
    DB_STATE_OPEN,
    READ_ONLY_REGEX,
  ...
  SQLitePlugin.prototype.open = function (success, error) {
    ...
    if (this.dbname in this.openDBs) {
      ...
      step2 = (function (_this) {
        return function () {
          cordova.exec(opensuccesscb, openerrorcb, "SQLitePlugin", "open", [
            _this.openargs,
          ]);
        };
      })(this);
  ...
  SQLitePlugin.prototype.sqlBatch = function (sqlStatements, success, error) {
    ...
    this.addTransaction(
      new SQLitePluginTransaction(this, myfn, error, success, true, false)
    );
  };
              ...
              return db.executeSql(
                ...
                function (resutSet) {
                  ...
                  return db.transaction(
                    function (tx) {
                      return tx.executeSql("UPDATE TestTable SET data = ?", [
                        "new-value",
                      ]);
                    },
                    function (tx_err) {
                                ...
                                function (tx4) {
                                  return tx4.executeSql(
                                    ...
                                    function (ignored, resutSet3) {
                                      ...
                                      if (
                                        resutSet3.rows.item(0).id === firstid
                                      ) {
                                        throw newSQLError(
    ...
    finishWithError: function (errorcb, message) {
      ...
      SQLiteFactory.deleteDatabase(
        ...
        function (err2) {
          ...
          errorcb(
            newSQLError(
              "CLEANUP DELETE ERROR: " + err2 + " for error: " + message
            )
          );
        }
      );
